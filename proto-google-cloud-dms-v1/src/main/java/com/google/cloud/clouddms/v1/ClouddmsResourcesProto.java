  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "le/rpc/status.proto\032\034google/api/annotations.proto\"\356\001\n"
          + "\tSslConfig\022>\n"
          + "\004type\030\001 \001(\0162+."
          + "google.cloud.clouddms.v1.SslConfig.SslTypeB\003\340A\003\022\027\n\n"
          ...
          + "oogle.cloud.clouddms.v1.CloudSqlSettingsB\003\340A\005\022\027\n\n"
          ...
          + "d.clouddms.v1.CloudSqlSettings.SqlDatabaseVersion\022O\n"
          + "\013user_labels\030\002 \003(\0132:.google."
          + "cloud.clouddms.v1.CloudSqlSettings.UserLabelsEntry\022\014\n"
          ...
          + "ogle.cloud.clouddms.v1.CloudSqlSettings.SqlActivationPolicy\0228\n"
          ...
          + "2=.google.cloud.clouddms.v1.CloudSqlSettings.DatabaseFlagsEntry\022R\n"
          ...
          + "+.google.cloud.clouddms.v1.MigrationJob.TypeB\003\340A\002\022\021\n"
          + "\tdump_path\030\t \001(\t\022\023\n"
          + "\006source\030\n"
          + " \001(\tB\003\340A\002\022\030\n"
          + "\013destination\030\013 \001(\tB\003\340A\002\022T\n"
          + "\030reverse_ssh_connectivity\030e \001(\01320.google.c"
          + "loud.clouddms.v1.ReverseSshConnectivityH\000\022T\n"
          + "\030vpc_peering_connectivity\030f \001(\01320.go"
          + "ogle.cloud.clouddms.v1.VpcPeeringConnectivityH\000\022P\n"
          + "\026static_ip_connectivity\030g \001(\0132"
          + "..google.cloud.clouddms.v1.StaticIpConnectivityH\000\0220\n"
          ...
          + ")datamigration.googleapis.com/MigrationJob\022Eprojects/"
          + "{project}/locations/{location}/migrationJobs/{migration_job}B\016\n"
          ...
          + "oogle.cloud.clouddms.v1.ConnectionProfile.LabelsEntry\022@\n"
          + "\005state\030\005 \001(\01621.google.cl"
          + "oud.clouddms.v1.ConnectionProfile.State\022\024\n"
          + "\014display_name\030\006 \001(\t\022A\n"
          + "\005mysql\030d \001(\01320.g"
          + "oogle.cloud.clouddms.v1.MySqlConnectionProfileH\000\022K\n\n"
          + "postgresql\030e \001(\01325.google.cl"
          + "oud.clouddms.v1.PostgreSqlConnectionProfileH\000\022G\n"
          ...
          + "ion}/connectionProfiles/{connection_profile}B\024\n"
          + "\022connection_profile\"\320\006\n"
          + "\035MigrationJobVerificationError\022Z\n\n"
          + "error_code\030\001 \001(\016"
          + "2A.google.cloud.clouddms.v1.MigrationJobVerificationError.ErrorCodeB\003\340A\003\022\032\n\r"
